...
class Analyser:
    ...
    # Loads a json dictionary with two fields: "total" and "list". Total contains all the word counts and list contains
    # the word list with the number of times each word occured in the text
    # The function then turns this into a data frame with each word having a zipf frequency assigned
    @staticmethod
    ...
    # Returns a data frame with top n words from a specified language and their calculated zipf values
    @staticmethod
    ...
    def getChartDf(article_data, num=24, mode='article', lang='en'):
        ...
        if mode == 'article':
            ...
            english_df = Analyser.top_n_words_zipf(num, lang)
